...
class StableDiffusionControlNetInpaintPipeline(
    ...
    def __init__(
        ...
        print("No binarization of the mask")
        self.mask_processor = VaeImageProcessor(
            vae_scale_factor=self.vae_scale_factor, do_normalize=False, do_binarize=False, do_convert_grayscale=True   ###############"No binarization of the mask"
        )
